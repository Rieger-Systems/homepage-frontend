<section class="bg-base-100 text-base-content px-6 py-20">
	<div class="mx-auto max-w-5xl">
		<h2 class="mb-10 text-center text-3xl font-semibold">Woran wir gerade arbeiten</h2>

		<div class="grid gap-8 md:grid-cols-2">
			<!-- AmaraCall -->
			<div
				class="bg-base-200 rounded-box hover:bg-base-300 p-6 shadow transition duration-300 hover:-translate-y-1 hover:shadow-lg"
			>
				<span class="badge badge-info mb-3">Demnächst</span>
				<h3 class="mb-3 text-xl font-bold">AmaraCall</h3>
			...
			<div
				class="bg-base-200 rounded-box hover:bg-base-300 p-6 shadow transition duration-300 hover:-translate-y-1 hover:shadow-lg"
			>
				<span class="badge badge-accent mb-3">Konzeptphase</span>
				<h3 class="mb-3 text-xl font-bold">A.M.A.R.A.</h3>
			...
			<div
				class="bg-base-200 rounded-box hover:bg-base-300 p-6 shadow transition duration-300 hover:-translate-y-1 hover:shadow-lg"
			>
				<span class="badge badge-warning mb-3">In Arbeit</span>
