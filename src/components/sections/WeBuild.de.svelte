...
>
	<div class="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 md:grid-cols-2">
		...
		<div class="bg-base-100 rounded-2xl p-10 shadow-xl">
			<h2 class="text-base-content mb-6 text-4xl font-bold tracking-tight">{de.webuild.title}</h2>
			<p class="text-base-content/80 text-lg leading-relaxed">{de.webuild.intro}</p>
			<p class="text-base-content/60 mt-6 text-sm leading-relaxed">{de.webuild.desc}</p>
			<div class="mt-10">
		...
		<div class="text-center">
			<p class="text-base-content/60 mb-2 text-sm tracking-widest uppercase">
				{de.webuild.ai.subline}
			</p>
			<h2 class="text-primary mb-4 text-4xl font-bold tracking-tight">{de.webuild.ai.title}</h2>
